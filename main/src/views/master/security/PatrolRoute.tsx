...
const PatrolRoute = () => {
      ...
      const {filteredCount: patrolRouteCount, hasLoaded} = usePatrolRouteStatus();
      const { t } = useTranslation();
      const topCards: cardType[] = [
        {
          title: 'Total Patrol Routes',
          subtitle: patrolRouteCount.toString(),
          bgcolor: 'success',
        },
      ];

        return (
          <PageContainer title="Patrol Route " description="This is the Patrol Route CRUD Page">
