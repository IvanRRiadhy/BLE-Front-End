...
import PeopleCountingList from 'src/components/master/Alarm Setting/PeopleCounting/peopleCountingList';
interface cardType {
  icon?: string;
  title: string;
  subtitle: string;
...
const FloorplanDevice = () => {
  ...
  const peopleCountingCount = useSelector((state: RootState) => state.PeopleCountingReducer.peopleCountingAlarmActiveCount);
  ...
  const topCards: cardType[] = [
    {
      title: 'Total Active PeopleCounting Alarm',
      subtitle: peopleCountingCount.toString(),
      bgcolor: 'primary',
    },
  ];
  return (
    <PageContainer title="People Counting Alarm" description="This is the People Counting Alarm CRUD Page">
      <Breadcrumb title="People Counting Alarm Table" />
      ...
      <AppCard>
        ...
        >
          <ParentCard title="People Counting Alarm List" codeModel={[
          ]}>
            {/* <FloorplanDeviceList /> */}
            <PeopleCountingList />
          </ParentCard>
