...
import { ExportTrackingTrans } from 'src/store/apps/crud/trackingTrans';

const TrackingTransExport = () => {
  ...
  const handleExport = (type: 'pdf' | 'excel') => {
    ...
    dispatch(ExportTrackingTrans(type));
...
export default TrackingTransExport;
