...
// import { ImportFloorplanDevice } from 'src/store/apps/crud/floorplanDevice';

// const FloorplanDeviceImport = () => {
...
//     await dispatch(ImportFloorplanDevice(formData));
...
// export default FloorplanDeviceImport;
