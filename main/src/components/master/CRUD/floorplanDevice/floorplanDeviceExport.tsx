...
import { ExportFloorplanDevice } from 'src/store/apps/crud/floorplanDevice';

const FloorplanDeviceExport = () => {
  ...
  const handleExport = (type: 'pdf' | 'excel') => {
    ...
    dispatch(ExportFloorplanDevice(type));
...
export default FloorplanDeviceExport;
