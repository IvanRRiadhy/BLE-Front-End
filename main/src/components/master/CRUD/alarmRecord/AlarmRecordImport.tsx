...
import { ImportAlarm } from 'src/store/apps/crud/alarmRecordTracking';

const AlarmRecordImport = () => {
  ...
  const handleImport = (type: 'pdf' | 'xls') => {
    ...
    await dispatch(ImportAlarm(formData));
...
export default AlarmRecordImport;
