...
import { ImportMaskedArea } from 'src/store/apps/crud/maskedArea';
import toast from 'react-hot-toast';
import { useQueryClient } from '@tanstack/react-query';

const MaskedAreaImport = () => {
  ...
  const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      await Promise.all([dispatch(ImportMaskedArea(formData)).unwrap(), delay(1000)]);
...
export default MaskedAreaImport;
