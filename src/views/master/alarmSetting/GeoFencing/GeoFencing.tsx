...
import { useGeoFencingAlarmStats } from 'src/hooks/AlarmSetting/useGeofence';
interface cardType {
  icon?: string;
  title: string;
  subtitle: string;
...
const FloorplanDevice = () => {
  ...
  const { activeCount, inactiveCount, hasLoaded } = useGeoFencingAlarmStats();
  ...
  const topCards: cardType[] = [
    ...
    {
      title: 'Total Inactive GeoFencing Alarm',
  ...
  return (
    <PageContainer title="People Tracking System" description="People Tracking System">
      ...
      <AppCard>
        ...
        >
          <ParentCard title="GeoFencing List" codeModel={[<AddGeoFencing key="AddGeoFencing" />]}>
            <GeoFencingList />
          </ParentCard>
        </Drawer>
      </AppCard>
