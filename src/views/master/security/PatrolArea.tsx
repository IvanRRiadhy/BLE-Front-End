...
// import AddEditPatrolArea from 'src/components/master/CRUD/patrolArea/AddEditPatrolArea';
import PatrolAreaList from 'src/components/master/Security/PatrolArea/PatrolAreaList';
// import PatrolAreaImport from 'src/components/master/CRUD/patrolArea/PatrolAreaImport';
// import PatrolAreaExport from 'src/components/master/CRUD/patrolArea/PatrolAreaExport';
import FloorplanFilter from 'src/components/master/CRUD/floorplan/FloorplanFilter';
import { usePatrolAreaStatus } from 'src/hooks/usePatrolArea';
...
const PatrolArea = () => {
  ...
  const {allPatrolAreaCount: patrolAreaCount} = usePatrolAreaStatus();
  ...
  const topCards: cardType[] = [
    ...
    {
      title: 'Total Patrol Areas',
      subtitle: patrolAreaCount.toString(),
      bgcolor: 'success',
    },
  ];
  return (
      ...
      <AppCard>
        ...
        >
          <ParentCard
            ...
            //   <PatrolAreaImport key="import" />,
            //   <PatrolAreaExport key="export" />,
